  ...
  return (
    ...
    >
      <div className="w-full px-6 md:px-12 lg:px-16 flex items-center justify-between relative">
        ...
        <nav className="hidden md:flex items-center gap-8 lg:gap-10 absolute left-1/2 -translate-x-1/2">
          {navLinks.map((link) => (
            <a
              ...
              className="text-sm uppercase tracking-[0.2em] font-bold text-white hover:text-zinc-300 transition-colors duration-300 relative py-1"
              data-cursor="magnetic"
            >
              {link.name}
            </a>
        ...
        <div className="flex items-center gap-4 md:gap-6 text-xs font-bold tracking-widest text-white">
          <a
